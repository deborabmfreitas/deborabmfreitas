...
```py
print('Hi! Welcome to my GitHub profile')
```
...
1. <a href="https://github.com/deborabmfreitas/ml-studies" target="_blank">ml-studies</a> (Hands on ML - book)
2. <a href="https://github.com/deborabmfreitas/llm-experiments" target="_blank">LLMs</a> (Experiments with LLMs)
3. <a href="https://github.com/deborabmfreitas/llm-experiments" target="_blank">Deep learning</a> (CIn - UFPE)
...
3. <a href="https://github.com/deborabmfreitas/projeto-clientes-clusterizacao" target="_blank">Customer Segmentation </a> (clustering)
